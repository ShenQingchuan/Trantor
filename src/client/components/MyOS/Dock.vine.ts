...
export function Dock(props: DockProps) {
  ...
  return vine`
    ...
    <div
      class="dock shadow fixed bottom-0 py-2 px-6 rounded bg-zinc-100/80 backdrop-blur dark:bg-dark-500 backdrop-blur-md backdrop-saturate-150 dock-transition"
      :class="{
